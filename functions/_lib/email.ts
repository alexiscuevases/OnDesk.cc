...
// Password reset, account lockout, invitation and two-factor emails used to
// live here. Pulse no longer authenticates anyone — ondesk owns identity and
// sends all four. What remains is ticket notification, which is Pulse's own.
