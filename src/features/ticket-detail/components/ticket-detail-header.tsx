...
export function TicketDetailHeader({ ticket, onBack, onEditTitle, onMerge, onDelete }: TicketDetailHeaderProps) {
	return (
			...
			<div className="shrink-0">
				<DropdownMenu>
					...
					<DropdownMenuContent align="end">
						<DropdownMenuItem onClick={onMerge}>Merge Ticket</DropdownMenuItem>
