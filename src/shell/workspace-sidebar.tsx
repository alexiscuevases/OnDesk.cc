...
import { LayoutDashboard, Ticket, Users, BarChart3, Settings, ChevronDown, ChevronRight, Building2, Plus, UserCircle, Palette, LogOut, ShieldCheck, ShoppingCart, Zap, Gauge, BookOpen, Shield } from "lucide-react";
...
export function WorkspaceSidebar() {
	...
	const navItems = [
		...
		{ id: "automations", label: "Automations", icon: Zap, badge: null, to: `/w/${slug}/automations` },
		{ id: "sla", label: "SLA Policies", icon: Gauge, badge: null, to: `/w/${slug}/sla` },
		{ id: "kb", label: "Knowledge Base", icon: BookOpen, badge: null, to: `/w/${slug}/kb` },
		{ id: "roles", label: "Roles & Permissions", icon: Shield, badge: null, to: `/w/${slug}/roles` },
